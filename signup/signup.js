...
function userSignup() {
    ...
    if (userName.length > 3) {
        ...
        validationMessage.textContent = "Username is not valid! length should be more than 3 characters";
        validationMessage.style.display = "block";
        return;
    }
    ...
    if (password.value.length >= 3){
        ...
        validationMessage.textContent = "Password must be at least 3 characters long";
        validationMessage.style.display = "block";
        return;
    }
