...
// follow button
followBtn.onclick = () => {
    window.open("https://www.youtube.com/@pranayy-c7q");
}


function navigateToPage() {
  // Change the URL to your desired page
  window.location.href = "eplore.html";
}
...
function singer1(){
    window.location.href = "singer1.html";
}
function singer2(){
    window.location.href = "singer2.html";
}
...
function toplaylist(){
    window.location.href = "playlistdata.html";
}
function toabout() {
    window.location.href = "about.html";
}
